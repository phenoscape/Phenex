...
public class AutocompleteFieldFactory {
     ...
     */
    private static void updateGlobalTermSelection(Object source, OBOClass term) {
        SelectionManager.inst().selectTerm(source, term, false);
    }

    public static AutocompleteField<OBOObject> createAutocompleteBox(Collection<OBOObject> terms) {
    ...
    public static TableCellEditor createAutocompleteEditor(Collection<OBOObject> terms) {
        return new AutocompleteCellEditor<OBOObject>(createAutocompleteBox(terms));
    }
            ...
            if (source instanceof JList) {
                ...
                try {
                    ...
                    if ((value instanceof SearchHit<?>) && (((SearchHit<?>)value).getHit() instanceof OBOClass)) {
                        updateGlobalTermSelection(this, (OBOClass)((SearchHit<?>)value).getHit());
                    } else {
    ...
    private static Logger log() {
        return Logger.getLogger(AutocompleteFieldFactory.class);
    }
