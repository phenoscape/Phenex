...
public class AutocompleteField<T> extends JComponent {
	...
	private final AutocompleteComboBox<SearchHit<T>> comboBox = new AutocompleteComboBox<SearchHit<T>>();
	...
	private final ComboBoxModel<SearchHit<T>> comboBoxModel = new EventComboBoxModel<SearchHit<T>>(completeList);
	...
	protected JComboBox<SearchHit<T>> getComboBox() {
	...
	protected ComboPopup getComboPopup(JComboBox<SearchHit<T>> comboBox) {
	...
	private class AutocompleteComboBox<E> extends JComboBox<E> {
